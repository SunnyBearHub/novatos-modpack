...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - Vs Mouse Dev Version - Mouse Engine", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - Vs Mouse Dev Version - Mouse Engine");
end