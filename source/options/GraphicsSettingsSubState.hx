...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		//var option:Option = new Option('Hide GF', //Name //removed for now
		//    'If checked, hide GF.', //Description
		//    'hideGf', //Save data variable name
		//    'bool', //Variable type
		//    false); //Default value
        //addOption(option);

		var option:Option = new Option('Ultra Optimization', //Name
		   'If checked, hide all elements of the Gameplay, except UI and BGs.', //Description
