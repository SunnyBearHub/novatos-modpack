...
class ClientPrefs {
	...
	public static var noChartEditor:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.noChartEditor = noChartEditor;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.tabi != null) {
			tabi = FlxG.save.data.tabi; //addhealthmax
	    }
		...
		if(FlxG.save.data.noChartEditor != null) {
			noChartEditor = FlxG.save.data.noChartEditor;
		}	
