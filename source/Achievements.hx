...
class Achievements {
	public static var achievementShits:Array<Dynamic> = [//Name, Description, Achievement save tag, Unlocks after, Hidden achievement
		...
		["You are not Welcome in my Clubhouse!",		"Beat Disk 1 with no Misses.",				'disk1_nomiss',			'Disk 1', 		false],
		["Im the Experiment",				"Beat Disk 2 with no Misses.",				'disk2_nomiss',         'Disk 2', 		false],
		["What a Good day to die, right?",			"Beat Disk 3 with no Misses.",				'disk3_nomiss',			'Disk 3', 		false],
